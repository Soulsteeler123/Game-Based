...
static const std::map<int, instruction> instructions {
    ...
    {0x70, {IN_LD, AM_R_R, RT_HL, RT_B}},
    {0x71, {IN_LD, AM_R_R, RT_HL, RT_C}},
    {0x72, {IN_LD, AM_R_R, RT_HL, RT_D}},
    {0x73, {IN_LD, AM_R_R, RT_HL, RT_E}},
    {0x74, {IN_LD, AM_R_R, RT_HL, RT_H}},
    {0x75, {IN_LD, AM_R_R, RT_HL, RT_L}},
    {0x76, {IN_HALT}},
